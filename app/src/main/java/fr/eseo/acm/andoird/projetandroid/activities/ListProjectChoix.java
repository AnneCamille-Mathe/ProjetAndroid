...
import fr.eseo.acm.andoird.projetandroid.adapters.ListProjectsAdapterChoix;
import fr.eseo.acm.andoird.projetandroid.entites.Project;

public class ListProjectChoix extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private ListProjectsAdapterChoix mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ListProjectsAdapterChoix(mProjectList,this);
